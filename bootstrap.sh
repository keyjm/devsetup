...
echo "  2. Copy ~/.ssh keys from old machine (or generate new ones)"
echo "  3. Sign in to: Firefox, VS Code, OrbStack, Orbstack"
echo "  4. Install VS Code extensions: code --install-extension <id>"
echo "     (or let the Brewfile vscode entries handle it on first launch)"
echo "============================================"
